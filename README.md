...
Setting `nexus_api_enable_creation: true` enables Nexus REST API creation features which are disabled in default installation. This in particular allows creation of the new repositories using the Nexus REST API.  
